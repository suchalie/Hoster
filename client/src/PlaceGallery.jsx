...
export default function PlaceGallery({place}){
    ...
    if(ShowAllphotos){
        return(
            <div className="absolute inset-0 bg-black opacity-100 text-white py-2 min-h-screen">
                ...
                {place?.photos?.length>0 && place.photos.map(photo=>(
                    <div className='object-cover w-90vw h-auto mx-auto mb-2 aspect-square' key= {photo._id}>
